...
public class ScriptedTrainRenderer extends TrainRendererBase {
    ...
    public void renderCar(int carIndex, double x, double y, double z, float yaw, float pitch, boolean doorLeftOpen, boolean doorRightOpen) {
        ...
        Vec3 vehicleOffset = train.vehicleRidingClient.getVehicleOffset();
        trainExtra.lastCarPosition[carIndex] = vehicleOffset == null
                ? new Vector3d(x, y, z)
                : new Vector3d(x + vehicleOffset.x, y + vehicleOffset.y, z + vehicleOffset.z);
